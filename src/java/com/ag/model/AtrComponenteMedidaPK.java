 ...
 */
@Embeddable
public class AtrComponenteMedidaPK implements Serializable {
    ...
    public AtrComponenteMedidaPK() {
    }

    public AtrComponenteMedidaPK(BigInteger idAtrComponente, int periodoIni) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof AtrComponenteMedidaPK)) {
            return false;
        }
        AtrComponenteMedidaPK other = (AtrComponenteMedidaPK) object;
    ...
    public String toString() {
        return "com.ag.model.AtrComponenteMedidaPK[idAtrComponente=" + idAtrComponente + ", periodoIni=" + periodoIni + "]";
    }
