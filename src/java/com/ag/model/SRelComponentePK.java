 ...
 */
@Embeddable
public class SRelComponentePK implements Serializable {
    ...
    public SRelComponentePK() {
    }

    public SRelComponentePK(BigInteger idComponente, BigInteger idComponenteHijo, int periodoIni) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SRelComponentePK)) {
            return false;
        }
        SRelComponentePK other = (SRelComponentePK) object;
    ...
    public String toString() {
        return "com.ag.model.SRelComponentePK[idComponente=" + idComponente + ", idComponenteHijo=" + idComponenteHijo + ", periodoIni=" + periodoIni + "]";
    }
