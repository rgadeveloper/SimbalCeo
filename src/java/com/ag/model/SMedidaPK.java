 ...
 */
@Embeddable
public class SMedidaPK implements Serializable {
    ...
    public SMedidaPK(BigInteger idComponente, short idTipoComponente, int periodo) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SMedidaPK)) {
            return false;
        }
        SMedidaPK other = (SMedidaPK) object;
    ...
    public String toString() {
        return "com.ag.model.SMedidaPK[idComponente=" + idComponente + ", idTipoComponente=" + idTipoComponente + ", periodo=" + periodo + "]";
    }
