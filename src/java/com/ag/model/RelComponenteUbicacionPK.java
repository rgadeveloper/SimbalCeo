 ...
 */
@Embeddable
public class RelComponenteUbicacionPK implements Serializable {
    ...
    public RelComponenteUbicacionPK() {
    }

    public RelComponenteUbicacionPK(BigInteger idZona, BigInteger idComponente, int periodoIni) {
        this.idZona = idZona;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof RelComponenteUbicacionPK)) {
            return false;
        }
        RelComponenteUbicacionPK other = (RelComponenteUbicacionPK) object;
    ...
    public String toString() {
        return "com.ag.model.RelComponenteUbicacionPK[idZona=" + idZona + ", idComponente=" + idComponente + ", periodoIni=" + periodoIni + "]";
    }
