 ...
 */
@Embeddable
public class RelComponenteMedidaPK implements Serializable {
    ...
    public RelComponenteMedidaPK() {
    }

    public RelComponenteMedidaPK(BigInteger idComponenteMedida, BigInteger idComponente, int periodoIni) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof RelComponenteMedidaPK)) {
            return false;
        }
        RelComponenteMedidaPK other = (RelComponenteMedidaPK) object;
    ...
    public String toString() {
        return "com.ag.model.RelComponenteMedidaPK[idComponenteMedida=" + idComponenteMedida + ", idComponente=" + idComponente + ", periodoIni=" + periodoIni + "]";
    }
